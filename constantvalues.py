class AllConstants:
    ...
    # def get_target_voltage_pe2(self):
    #     return self._target_voltage_pe2

    # def set_target_voltage_pe2(self, x):
    #     self._target_voltage_pe2 = x

    # def get_target_current_pe2(self):
    #     return self._target_current_pe2

    # def set_target_current_pe2(self, x):
    #     self._target_current_pe2 = x
